...
dat_rt_acc %>% 
  ...
  select(observer, block, condition, acc, rt) -> d_lmer

  
modelRT <- lmer(medianRT ~ block*payment + (1|subj), data = RT)  
modelAcc <- lmer(medianAcc ~ block*payment + (1|subj), data = accuracy)  
modelProportion <- lmer(medianAcc ~ block*payment + (1|subj), data = proportion)  
